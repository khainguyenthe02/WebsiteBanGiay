<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TrangTimKiem.aspx.cs" Inherits="BTLW.TrangTimKiem" %>
...
<body>
   <div class="login" >       
    ...
    <div class="filter">
        <h3 class="filter__heading">Lọc sản phẩm theo giá</h3>
        <ul class="filter__list">
            <a href="#" runat="server" id="Filter_01">&le; 300.000 đ</a> |
            <a href="#" runat="server" id="Filter_02">300.000đ - 600.000đ</a> |
            <a href="#" runat="server" id="Filter_03">&ge; 600.000đ</a> 
        ...
        <div class ="spbanchay">
           <div class="all-products_heading">
            ...
            <asp:ListView ID="sanphammoi" runat="server">
              <ItemTemplate>
                   <div class="cardHot">
                        <a style="text-decoration:none; color:black" href="TrangChiTietSP.aspx?pi=<%# Eval("sId")  %>">
                            <img src="<%# Eval("sImage") %>" title="Giày dép" />
                            <h2 id="h2"><%# Eval("sName") %></h2>
                            <p id="gia"><%# Eval("fPrice") %> đồng</p>
                        </a>
                   </div>
              </ItemTemplate>
            </asp:ListView>
