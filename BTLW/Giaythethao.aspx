<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Giaythethao.aspx.cs" Inherits="BTLW.Giaythethao" %>
...
<body>
   <div class="login" >       
    ...
    <div class="up">
        <div class="abc">
            <a href="TrangChu.aspx"><strong>TRANG CHỦ</strong></a> / <a href="Giaythethao.aspx"><strong>GIÀY THỂ THAO</strong></a>
        </div>
    </div>

    <div class="content">
        <div class ="spbanchay">
            <h1 class ="h1">Giày thể thao</h1>
            <hr />
            <%= hienGiayTheThao() %>
        </div>
    </div>
