<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Lienhe.aspx.cs" Inherits="BTLW.Lienhe" %>
...
<body>
     ...
     <div class="header">  
        ...
        <ul class="menu">
            ...
            <li style="background-color:cadetblue"><a href="Lienhe.aspx">Liên hệ</a></li>
        ...
        <div class="left" >
            <table>
                <tr>
                    <td>
                        <ul> 
                            <li><h3>CÔNG TY TNHH HKT</h3></li>
                            <li><b>Open:</b> 8.00 AM<br />
                                <b>Close:</b> 23.00 PM 
                            </li> 
                        
                            <li><b>Contact us:</b> 06771508</li>
                            <li><b>Email:</b> hktgroup@gmail.com</li> 
                            <li><b>Address:</b> 96A Định Công, Hoàng Mai, Hà Nội</li>
                        </ul> 
                    </td>
                    <td>
                       <span>  <b>MIỄN PHÍ GIAO HÀNG: Cho Đơn Hàng Từ 800.000 VNĐ</b></span><br />
                       <span>   <b>CHÍNH SÁCH ĐỔI TRẢ: Đổi Trả Hàng Khi Đủ Điều Kiện</b></span>
                    </td>
                </tr>
                <tr>
                    <td><img src= "./img/img4.jpg" style =" width: 90%; height: 380px; margin: 20px; " /></td>
                    <td><img src="./img/lienhe2.jpg" style="width: 90%; height: 380px; margin-left: 10px;" /></td>
                </tr>
